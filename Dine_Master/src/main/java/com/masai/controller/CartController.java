...
public class CartController {
	...
	public String addToCart(@PathVariable Integer id, HttpSession session) {
		...
		session.setAttribute("message","Item added in Reservation Successfully...");
	...
	public String checkout(Model model) {
		...
		model.addAttribute("total",GlobalData.cart.stream().mapToDouble(Product::getPrice).sum()+500+30);
